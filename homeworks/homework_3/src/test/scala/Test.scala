...
object Test extends TestSuite {
  val tests = Tests {
    ...
    'test_referenceCell - {
      ...
      /* row = 3 */
      val cellRef30 = new ReferenceCell(0, 1, table)
      val cellRef31 = new ReferenceCell(3, 1, table)
      val cellRef32 = new ReferenceCell(3, 0, table)
      /* row = 4 */
      val cellRef40 = new ReferenceCell(2, 3, table)
      val cellRef41 = new ReferenceCell(5, 0, table)
      val cellRef42 = new ReferenceCell(4, 1, table)
      ...
      table.setCell(3, 0, cellRef30)
      table.setCell(3, 1, cellRef31)
      table.setCell(3, 2, cellRef32)
      table.setCell(4, 0, cellRef40)
      table.setCell(4, 1, cellRef41)
      table.setCell(4, 2, cellRef42)
      ...
      for (i <- 0 until 15) {
        ...
        i match {
          ...
          case 9 => assert(value == "cyclic")
          case 10 => assert(value == "cyclic")
          case 11 => assert(value == "cyclic")
          case 12 => assert(value == "outOfRange")
          case 13 => assert(value == "outOfRange")
          case 14 => assert(value == "outOfRange")
          case _ => assert(false)
        }
      }
    }
